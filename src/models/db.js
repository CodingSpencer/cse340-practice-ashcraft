...
// Force Node's core network layer to recognize this file as a trusted authority
...
const pool = new Pool({
    ...
    ssl: {
        ca: [caCert.toString()],  // Use the certificate content, not the file path
        rejectUnauthorized: false,  // Keep this true for proper security
...
if (process.env.NODE_ENV && process.env.NODE_ENV.includes('dev') && process.env.ENABLE_SQL_LOGGING === 'true') {
    /**
